...
if (vectorMapWorldMarkersColors) {
    var worldemapmarkers = new jsVectorMap({
        ...
        markers: [{
                ...
                style: {
                    image: "/Content/assets/images/flags/us.svg",
                }
            },
            {
                name: "Russia",
                ...
                style: {
                    image: "/Content/assets/images/flags/russia.svg",
                }
            },
            {
                name: "Spain",
                ...
                style: {
                    image: "/Content/assets/images/flags/spain.svg",
                }
            },
            {
                name: "Italy",
                ...
                style: {
                    image: "/Content/assets/images/flags/italy.svg",
                }
            },
            {
                name: "Germany",
                ...
                style: {
                    image: "/Content/assets/images/flags/germany.svg",
                }
            },
        ],
        markerStyle: {
