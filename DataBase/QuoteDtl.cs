...
namespace Inspection.Web.DataBase
{
    ...
    public partial class QuoteDtl
    {
        ...
        public string WebAppData_c { get; set; }
        public Nullable<bool> SingleLine_c { get; set; }
        public string BuyingOption_c { get; set; }
        public string ShuklaSys_c { get; set; }
        public string SetID_c { get; set; }
        public Nullable<int> WebAppLine_c { get; set; }
        public Nullable<int> WebAppQty_c { get; set; }
    }
}
