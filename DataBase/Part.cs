...
namespace Inspection.Web.DataBase
{
    ...
    public partial class Part
    {
        ...
        public string LineCode_c { get; set; }
        public Nullable<int> Forecast_c { get; set; }
        public Nullable<int> MAFIALot_c { get; set; }
        public Nullable<bool> LotInspect_c { get; set; }
        public Nullable<bool> ServicePart_c { get; set; }
        public Nullable<bool> SingleUse_c { get; set; }
        public string FDA_InvcDesc_c { get; set; }
        public string FDA_Methodology_c { get; set; }
        public string FDA_Composition_c { get; set; }
        public Nullable<int> QtyPerPkg_c { get; set; }
        public string FDA_Classification_c { get; set; }
        public string FDA_ProductCode_c { get; set; }
        public string UDIPart_c { get; set; }
        public Nullable<int> FullSystemDiscount_c { get; set; }
        public string CustomerPartNum_c { get; set; }
    }
}
